...
% - Automatisk liten tekst i titlegraphic
...
\titlegraphic{This is a text with comment on the content of the presentation. %For example; Collaboration with \dots, Funding by \dots, etc.
}
